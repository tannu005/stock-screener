...
export default function HomePage() {
  const { initialize, isLoading, allStocks, user, isAuthModalOpen, setAuthModalOpen } = useScreenerStore();
              ...
              <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div className="glass-card p-8 rounded-2xl border border-warning/20 hover:border-warning/50 transition-all duration-500 shadow-xl group">
                    ...
                    <h3 className="text-white text-xl font-bold mb-3">Institutional Grade</h3>
                    <p className="text-white/60 text-sm leading-relaxed font-mono">Robust architecture ensuring reliability even during extreme market volatility.</p>
                  </div>
                </div>
              </div>
            </section>
              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <button 
                    ...
                    className="px-10 py-4 border-2 border-primary text-primary font-bold rounded-xl hover:bg-primary/5 transition-all transform hover:scale-105 active:scale-95">
                    Contact Enterprise
                  </button>
                </div>
              </div>
