  ...
  const testimonials = [
    {
      ...
      quote: 'The polygon integration completely transformed our algorithmic execution. Outstanding reliability.',
      image: '👨‍💼',
    },
    {
    ...
    },
    {
      ...
      quote: 'Seamless architecture that scaled instantly during peak market hours. Flawless execution.',
      image: '👨‍💻',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20">
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-white/70 text-lg max-w-2xl font-mono">Architected for institutional resilience and uncompromising data accuracy.</p>
          </div>
