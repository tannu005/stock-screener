      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative glass-card rounded-[2.5rem] border border-white/10 p-8 md:p-12 hover:border-white/30 transition-all"
          >
            <div className="mb-10">
              <h3 className="text-2xl font-bold text-white mb-2">Basic</h3>
              <div className="flex items-baseline gap-2">
                <span className="text-5xl font-bold text-white">$0</span>
                <span className="text-white/50 font-mono">/forever</span>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-10">
              <div className="flex items-center gap-3 text-white/80">
                ...
                <span className="text-sm font-mono">5 Stocks Watchlist</span>
              </div>
              <div className="flex items-center gap-3 text-white/80">
                <Check size={14} className="text-white/50" />
                <span className="text-sm font-mono">15-minute Delayed Data</span>
              </div>
              <div className="flex items-center gap-3 text-white/80 opacity-50">
                <Check size={14} className="text-white/30" />
                <span className="text-sm font-mono line-through">CSV / Excel Export</span>
              </div>
              <div className="flex items-center gap-3 text-white/80 opacity-50">
                <Check size={14} className="text-white/30" />
                <span className="text-sm font-mono line-through">Portfolio Simulation</span>
              </div>
              <div className="flex items-center gap-3 text-white/80 opacity-50">
                <Check size={14} className="text-white/30" />
                <span className="text-sm font-mono line-through">Real-time Tick Data</span>
              </div>
            </div>

            <button
              className="w-full py-4 border-2 border-white/20 text-white font-bold rounded-2xl hover:bg-white/5 transition-all"
            >
              Current Plan
            </button>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4 mb-10">
              <div className="flex items-center gap-3 text-white/80">
                ...
                <span className="text-sm font-mono">Unlimited Watchlists</span>
              </div>
              <div className="flex items-center gap-3 text-white/80">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center">
                  <Check size={14} className="text-primary" />
                </div>
                <span className="text-sm font-mono">Real-time Tick Data via WebSocket</span>
              </div>
              <div className="flex items-center gap-3 text-white/80">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center">
                  <Check size={14} className="text-primary" />
                </div>
                <span className="text-sm font-mono">CSV & Excel Data Export</span>
              </div>
              <div className="flex items-center gap-3 text-white/80">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center">
                  <Check size={14} className="text-primary" />
                </div>
                <span className="text-sm font-mono">Portfolio Simulation & Live P&L</span>
              </div>
              <div className="flex items-center gap-3 text-white/80">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center">
                  <Check size={14} className="text-primary" />
                </div>
                <span className="text-sm font-mono">Premium Analytics (Sector Heatmaps)</span>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-4 mb-10">
              <div className="flex items-center gap-3 text-white/80">
                <Check size={14} className="text-white/50" />
                <span className="text-sm font-mono">Dedicated Account Manager</span>
              </div>
              <div className="flex items-center gap-3 text-white/80">
                <Check size={14} className="text-white/50" />
                <span className="text-sm font-mono">Custom Data Integrations</span>
              </div>
              <div className="flex items-center gap-3 text-white/80">
                <Check size={14} className="text-white/50" />
              ...
              <div className="flex items-center gap-3 text-white/80">
                <Check size={14} className="text-white/50" />
                <span className="text-sm font-mono">White-label Reports</span>
              </div>
              <div className="flex items-center gap-3 text-white/80">
                <Check size={14} className="text-white/50" />
                <span className="text-sm font-mono">24/7 Phone Support</span>
              </div>
            </div>

            <button
              onClick={() => window.location.href = 'mailto:enterprise@stockscreener.pro?subject=Enterprise%20Inquiry'}
              className="w-full py-4 border-2 border-white/20 text-white font-bold rounded-2xl hover:bg-white/5 transition-all"
            >
              Contact Sales
            </button>
