...
const MarketSentimentPanel = memo(() => {
    ...
    useEffect(() => {
        ...
        gsap.fromTo(sectionRef.current.querySelectorAll('[data-card]'), 
            { opacity: 0, y: 20 },
        ...
        >
            <div className="max-w-7xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-white/70 text-sm">Real-time advance/decline ratio tracking sentiment shifts across 5,000 stocks</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
                    ...
                    <div data-card className="glass-card p-5 rounded-xl group hover:scale-105 transition-transform duration-300 border border-white/8">
                        <div className="text-white/80 text-xs font-mono tracking-widest mb-2">SENTIMENT</div>
                        <div
                        ...
                        <div className="text-white/50 text-xs leading-relaxed">Tracks bullish vs bearish momentum</div>
                    </div>
                    ...
                    <div data-card className="glass-card p-5 rounded-xl group hover:scale-105 transition-transform duration-300 border border-success/20">
                        ...
                        <div className="text-white/50 text-xs">Stocks with positive momentum</div>
                    </div>
                    ...
                    <div data-card className="glass-card p-5 rounded-xl group hover:scale-105 transition-transform duration-300 border border-danger/20">
                        ...
                        <div className="text-white/50 text-xs">Stocks experiencing declines</div>
                    </div>
                    ...
                    <div data-card className="glass-card p-5 rounded-xl group hover:scale-105 transition-transform duration-300 border border-warning/20">
                        ...
                        <div className="text-white/50 text-xs">Flat or neutral price action</div>
                    </div>
                </div>
            </div>
        </section>
